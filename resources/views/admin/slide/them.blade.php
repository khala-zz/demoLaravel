                    ...
                    <div class="col-lg-7" style="padding-bottom:120px">
                        ...
                        <form action="admin/slide/them" method="POST" enctype="multipart/form-data"> <!-- Form bắt buộc phải có thuộc tính enctype thì mới up được file lên -->
                            ...
                            <div class="form-group">
                                <p><label>Tên</label></p>
                                <input type="text" class="form-control input-width" name="Ten" placeholder="Nhập Tên của Slide" value="{{ old('slide_name') }}" />
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control input-width" name="link" placeholder="Nhập Đường dẫn URL cho Slide (có thể bỏ qua)" value="{{ old('slide_url') }}" />
                            </div>
