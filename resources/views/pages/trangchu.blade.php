                    ...
                    <div class="panel-body">
                        @foreach($theloai as $tl)
                            ...
                            <div class="row-item row">
                                ...
                                <div class="col-md-8 border-right">
                                    <div class="col-md-5">
                                        <a href="tintuc/{{$tin1['id']}}/{{ $tin1['TieuDeKhongDau'] }}.html">
                                            <img class="img-responsive" src="upload/tintuc/{{ $tin1['Hinh'] }}" alt="Hình ảnh đại diện của bài viết">
                                        </a>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    @foreach($data->all() as $tintuc_conlai)
                                        <a href="tintuc/{{ $tintuc_conlai['id'] }}/{{ $tintuc_conlai['TieuDeKhongDau'] }}.html">
                                            <h4>
                                                <span class="glyphicon glyphicon-list-alt"></span>
                                                {{ $tintuc_conlai['TieuDe'] }}
                                            </h4>
                                        </a>
                                    @endforeach
                                </div>
