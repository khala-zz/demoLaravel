        ...
        <div class="col-md-9 ">
            <div class="panel panel-default">
                <div class="panel-heading" style="background-color:#337AB7; color:white;">
                    <h4><b>Tìm thấy tổng cộng {{ count($tintuc) }} tin tức có liên quan đến từ khóa "{{ $tukhoa }}".</b></h4>
                </div>
                ...
                @foreach($tintuc as $chitiet)
                    <div class="row-item row">
                        ...
                        <div class="col-md-9">
                            <h3><a href="tin-tuc/{{ $chitiet->TieuDeKhongDau }}.html">{!! keywordHighlight($tukhoa,$chitiet->TieuDe) !!}</a></h3>
                            <p>{!! keywordHighlight($tukhoa,$chitiet->TomTat) !!}</p>
